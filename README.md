...
1. Google account with [Earth Engine access](https://earthengine.google.com/signup/).
2. A **Google Cloud project** with the **Earth Engine API** enabled.
3. Your **project id** (not the display name) for initialization.
...
Complete the browser flow once. Then run the demo.
